...
class Payment(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        super().save(*args, **kwargs)
        self.student_fee.paid_amount = sum(p.amount for p in self.student_fee.payments.all())
...
class Notification(models.Model):
    student = models.ForeignKey(Student, on_delete=models.CASCADE, related_name="notifications", blank=True, null=True)
    title = models.CharField(max_length=200)
