...
from .models import (
    ...
    StudentFee, Payment, StudentProject, Achievement, Notification
)
...
def _student_analytics(request):
    ...
    projects = StudentProject.objects.filter(student=student) if any(f.name == "student" for f in Project._meta.fields) else StudentProject.objects.none()
